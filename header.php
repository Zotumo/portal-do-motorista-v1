...
<body>
    ...
    <a class="nav-link" href="index.php#minha-escala"><i class="fas fa-user-clock"></i> Minha Escala</a>
                     ...
                     <li class="nav-item" id="nav-perfil" <?php if (!$usuario_logado) echo 'style="display: none;"'; ?>> <a class="nav-link" href="index.php#minha-escala"><i class="fas fa-user"></i> <span id="nome-usuario-nav"><?php echo htmlspecialchars($nome_usuario); ?></span></a> </li>
