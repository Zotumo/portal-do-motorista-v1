...
$blocos_funcionalidades = [
    ...
    // Vermelho CMTU
    ['titulo' => 'Gerenciar Funcionários','link' => 'motoristas_listar.php',        'icone' => 'fas fa-id-card',           'cor_classe' => 'bg-cmtu-vermelho text-white','permissao_array' => $niveis_acesso_ver_motoristas,       'descricao' => 'Gerencie ou consulte o cadastro dos funcionários'],
    // Cinza
