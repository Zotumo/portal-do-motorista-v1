    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-danger fixed-top">
        ...
        <div class="collapse navbar-collapse" id="adminNavbar">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item d-md-none nav-admin-main-item">
                    <a class="nav-link <?php $pags_tabelas = ['tabelas_hub.php', 'programacao_diaria_listar.php', 'programacao_diaria_formulario.php', 'eventos_diario_pesquisar.php', 'eventos_diario_gerenciar.php']; echo in_array(basename($_SERVER['PHP_SELF']), $pags_tabelas) && strpos($current_script_directory, $expected_admin_path . '/relatorios') === false ? 'active' : ''; ?>" href="<?php echo $admin_base_link; ?>tabelas_hub.php"> 
                        <i class="fas fa-list fa-fw"></i> Gerenciar Tabelas
                    </a>
                </li>
                <?php endif; ?>
                ...
                <li class="nav-item d-md-none nav-admin-main-item">
                    <a class="nav-link <?php $pags_locais = ['locais_listar.php', 'local_formulario.php']; echo in_array(basename($_SERVER['PHP_SELF']), $pags_locais) && strpos($current_script_directory, $expected_admin_path . '/relatorios') === false ? 'active' : ''; ?>" href="<?php echo $admin_base_link; ?>locais_listar.php">
